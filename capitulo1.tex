...
Diremos que $p_1$, $p_2$, \ldots, $p_n$ s\ao {\it premissas}\index{Premissas} (ou hip\'otese\index{Hip\'otese}) e $q$ \'e a {\it conclus\aoi}.\index{Conclus\aoi} Um argumento \'e v\'alido (ou um teorema \'e verdade) se \'e uma tautologia. Neste caso, dizemos que $q$ (a conclus\aoi) \'e uma {\it consequ\^encia l\'ogica}\index{Consequ\^encia L\'ogica} de $p_1$, $p_2$, \ldots, $p_n$ (as premissas). 
